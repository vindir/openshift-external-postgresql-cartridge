%global cartridgedir %{_libexecdir}/openshift/cartridges/postgresql-0.1
...
Requires:      httpd
Obsoletes:     cartridge-postgresql-0.1

%description
Provides postgresql support to OpenShift
...
%changelog
* Wed Jan 09 2013 Unknown name 1.3.2-1
...
- Create routes.json for postgresql cart. (mpatel@redhat.com)
...
- Fix README to use new variable scheme + fixup wrong variable in postgresql cart.
  (ramr@redhat.com)
...
- Fix 'Obsoletes' for jbosseap6, port-proxy, mongodb-2.2, and postgresql
  (pmorie@gmail.com)
...
- Fix for bugz 844209 - stopped postgresql application becomes to start status after
...
- Merge pull request #466 from smarterclayton/bug849950_postgresql_missing_proper_tag
  (openshift+bot@redhat.com)
...
- add maven mirror for postgresql builder (bdecoste@gmail.com)

* Mon Jul 09 2012 William DeCoste <wdecoste@redhat.com> 0.29.4-1
- maven repo for postgresql builder

* Mon Jul 09 2012 Dan McPherson <dmcphers@redhat.com> 0.29.3-1
- bz 821921 - create .m2 for postgresql builder (bdecoste@gmail.com)
...
- Support for customizing error pages in postgresql. (mpatel@redhat.com)
...
- Merge branch 'master' into US2109 (rmillner@redhat.com)
- Automatic commit of package [openshift-origin-cartridge-postgresql-0.1] release [0.27.2-1].
  (admiller@redhat.com)
...
- Cleanup and restore custom env vars support and fixup permissions.
  (ramr@redhat.com)
- Automatic commit of package [openshift-origin-cartridge-postgresql-0.1] release [0.26.4-1].
  (admiller@redhat.com)
- Merge branch 'master' into US2109 (ramr@redhat.com)
